...
TextureFormat LNTextureFormat_TranslateTo(LNTextureFormat value);
LNTextureFormat LNTextureFormat_TranslateFrom(TextureFormat value);

void LNTypeDef_CheckCommonDefinition()
{
	//static_assert(LN_FMT__TERMINATOR != (int)TextureFormat::_Count);
...
typedef enum tagLNDeviceButtonType
{
	...
	LN_DEVICEBUTTONTYPE_JOYSTICK_BUTTON,		/** ジョイパッドのボタン */
	LN_DEVICEBUTTONTYPE_JOYSTICK_POV,			/** ジョイパッドのPOV */
	LN_DEVICEBUTTONTYPE_JOYSTICK_AXIS,			/** ジョイパッドの軸 */
...
typedef enum tagLNDeviceButton
{
	...
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_1,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_2,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_3,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_4,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_5,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_6,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_7,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_8,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_9,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_10,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_11,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_12,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_13,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_14,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_15,
	LN_DEVICEBUTTON_JOYSTICK_BUTTON_16,

	LN_DEVICEBUTTON_JOYSTICK_POV_UP,
	LN_DEVICEBUTTON_JOYSTICK_POV_RIGHT,
	LN_DEVICEBUTTON_JOYSTICK_POV_DOWN,
	LN_DEVICEBUTTON_JOYSTICK_POV_LEFT,

	LN_DEVICEBUTTON_JOYSTICK_AXIS_1_MINUIS,      /** X1 -1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_1_PLUS,        /** X1  1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_2_MINUIS,      /** Y1 -1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_2_PLUS,        /** Y1  1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_3_MINUIS,      /** X2 -1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_3_PLUS,        /** X2  1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_4_MINUIS,      /** Y2 -1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_4_PLUS,        /** Y2  1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_5_MINUIS,      /** X3 -1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_5_PLUS,        /** X3  1.0     XInput LT */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_6_MINUIS,      /** Y3 -1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_6_PLUS,        /** Y3  1.0     XInput RT */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_7_MINUIS,      /** X4 -1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_7_PLUS,        /** X4  1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_8_MINUIS,      /** Y4 -1.0 */
	LN_DEVICEBUTTON_JOYSTICK_AXIS_8_PLUS,        /** Y4  1.0 */
