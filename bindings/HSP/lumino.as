...
#cmd LNConfig_SetEngineLogEnabled $0064
#cmd LNConfig_RegisterArchive $0065
#cmd LNConfig_SetFileAccessPriority $0066
#cmd LNConfig_SetUserWindowHandle $0067
#cmd LNConfig_SetSoundCacheSize $0068
#cmd LNConfig_SetDirectMusicMode $0069
#cmd LNConfig_SetDirectMusicReverbLevel $006A
#cmd LNEngine_Initialize $006B
#cmd LNEngine_InitializeAudio $006C
#cmd LNEngine_UpdateFrame $006D
#cmd LNEngine_IsEndRequested $006E
#cmd LNEngine_Terminate $006F
#cmd LNVersion_GetMajor $0070
#cmd LNVersion_GetMinor $0071
#cmd LNVersion_GetRevision $0072
#cmd LNVersion_GetBuild $0073
#cmd LNVersion_GetString $0074
#cmd LNVersion_IsAtLeast $0075
#cmd LNError_GetLastErrorCode $0076
#cmd LNError_GetLastErrorMessage $0077
#cmd LNObject_Release $0078
#cmd LNObject_AddRef $0079
#cmd LNObject_GetRefCount $007A
#cmd LNVector2_GetLength $007B
#cmd LNVector2_GetSquareLength $007C
#cmd LNVector2_Set $007D
#cmd LNVector2_Normalize $007E
#cmd LNVector2_NormalizeV $007F
#cmd LNVector3_GetLength $0080
#cmd LNVector3_GetSquareLength $0081
#cmd LNVector3_Set $0082
#cmd LNVector3_SetVZ $0083
#cmd LNVector3_Normalize $0084
#cmd LNVector3_NormalizeV $0085
#cmd LNVector3_Dot $0086
#cmd LNVector3_Cross $0087
#cmd LNVector3_Reflect $0088
#cmd LNVector3_Slide $0089
#cmd LNVector3_Lerp $008A
#cmd LNVector3_CatmullRom $008B
#cmd LNVector3_Transform $008C
#cmd LNVector3_TransformCoord $008D
#cmd LNVector4_Set $008E
#cmd LNMatrix_GetRight $008F
#cmd LNMatrix_GetUp $0090
#cmd LNMatrix_GetFront $0091
#cmd LNMatrix_GetPosition $0092
#cmd LNMatrix_Identity $0093
#cmd LNMatrix_Translate $0094
#cmd LNMatrix_TranslateVec3 $0095
#cmd LNMatrix_RotateX $0096
#cmd LNMatrix_RotateY $0097
#cmd LNMatrix_RotateZ $0098
#cmd LNMatrix_Rotate $0099
#cmd LNMatrix_RotateVec3 $009A
#cmd LNMatrix_RotateAxis $009B
#cmd LNMatrix_RotateQuaternion $009C
#cmd LNMatrix_Scale $009D
#cmd LNMatrix_ScaleXYZ $009E
#cmd LNMatrix_ScaleVec3 $009F
#cmd LNMatrix_Multiply $00A0
#cmd LNMatrix_Inverse $00A1
#cmd LNMatrix_Transpose $00A2
#cmd LNMatrix_ViewTransformLH $00A3
#cmd LNMatrix_ViewTransformRH $00A4
#cmd LNMatrix_PerspectiveFovLH $00A5
#cmd LNMatrix_PerspectiveFovRH $00A6
#cmd LNMatrix_OrthoLH $00A7
#cmd LNMatrix_OrthoRH $00A8
#cmd LNMatrix_GetEulerAngles $00A9
#cmd LNMatrix_Decompose $00AA
#cmd LNQuaternion_Set $00AB
#cmd LNQuaternion_Identity $00AC
#cmd LNQuaternion_RotationAxis $00AD
#cmd LNQuaternion_RotationMatrix $00AE
#cmd LNQuaternion_RotationYawPitchRoll $00AF
#cmd LNQuaternion_Normalize $00B0
#cmd LNQuaternion_Conjugate $00B1
#cmd LNQuaternion_Multiply $00B2
#cmd LNQuaternion_Slerp $00B3
#cmd LNGameAudio_PlayBGM $00B4
#cmd LNGameAudio_PlayBGMMem $00B5
#cmd LNGameAudio_StopBGM $00B6
#cmd LNGameAudio_PlayBGS $00B7
#cmd LNGameAudio_PlayBGSMem $00B8
#cmd LNGameAudio_StopBGS $00B9
#cmd LNGameAudio_PlayME $00BA
#cmd LNGameAudio_PlayMEMem $00BB
#cmd LNGameAudio_StopME $00BC
#cmd LNGameAudio_PlaySE $00BD
#cmd LNGameAudio_PlaySE3D $00BE
#cmd LNGameAudio_PlaySE3DXYZ $00BF
#cmd LNGameAudio_PlaySEMem $00C0
#cmd LNGameAudio_PlaySE3DMem $00C1
#cmd LNGameAudio_PlaySE3DMemXYZ $00C2
#cmd LNGameAudio_StopSE $00C3
#cmd LNGameAudio_SetBGMVolume $00C4
#cmd LNGameAudio_SetBGSVolume $00C5
#cmd LNSoundListener_SetPosition $00C6
#cmd LNSoundListener_SetDirection $00C7
#cmd LNSoundListener_SetUpDirection $00C8
#cmd LNSoundListener_SetVelocity $00C9
#cmd LNSoundListener_SetPositionXYZ $00CA
#cmd LNSoundListener_SetDirectionXYZ $00CB
#cmd LNSoundListener_SetUpDirectionXYZ $00CC
#cmd LNSoundListener_SetVelocityXYZ $00CD
#cmd LNSound_Create $00CE
#cmd LNSound_CreateMem $00CF
#cmd LNSound_GetVolume $00D0
#cmd LNSound_SetVolume $00D1
#cmd LNSound_GetPitch $00D2
#cmd LNSound_SetPitch $00D3
#cmd LNSound_IsLoopEnabled $00D4
#cmd LNSound_SetLoopEnabled $00D5
#cmd LNSound_Is3DEnabled $00D6
#cmd LNSound_Set3DEnabled $00D7
#cmd LNSound_GetPlayingMode $00D8
#cmd LNSound_SetPlayingMode $00D9
#cmd LNSound_GetPlayingState $00DA
#cmd LNSound_GetPlayedSamples $00DB
#cmd LNSound_GetTotalSamples $00DC
#cmd LNSound_GetSamplingRate $00DD
#cmd LNSound_SetEmitterPosition $00DE
#cmd LNSound_SetEmitterVelocity $00DF
#cmd LNSound_SetEmitterMaxDistance $00E0
#cmd LNSound_SetLoopRange $00E1
#cmd LNSound_Play $00E2
#cmd LNSound_Stop $00E3
#cmd LNSound_Pause $00E4
#cmd LNSound_Resume $00E5
#cmd LNSound_FadeVolume $00E6
#cmd LNSound_SetEmitterPositionXYZ $00E7
#cmd LNSound_SetEmitterVelocityXYZ $00E8
#cmd LNTexture_GetSize $00E9
#cmd LNTexture2D_Create $00EA
#cmd LNTexture2D_CreateFromFile $00EB
#cmd LNSceneNode_IsVisible $00EC
#cmd LNSceneNode_SetVisible $00ED
#cmd LNSceneNode_GetPosition $00EE
#cmd LNSceneNode_SetPosition $00EF
#cmd LNSprite_GetTexture $00F0
