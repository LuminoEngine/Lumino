...
#cmd LNApplication_Finalize $0072
#cmd LNVector2_GetLength $0073
#cmd LNVector2_GetSquareLength $0074
#cmd LNVector2_Set $0075
#cmd LNVector2_Normalize $0076
#cmd LNVector2_NormalizeV $0077
#cmd LNVector3_GetLength $0078
#cmd LNVector3_GetSquareLength $0079
#cmd LNVector3_Set $007A
#cmd LNVector3_SetVZ $007B
#cmd LNVector3_Normalize $007C
#cmd LNVector3_NormalizeV $007D
#cmd LNVector3_Dot $007E
#cmd LNVector3_Cross $007F
#cmd LNVector3_Reflect $0080
#cmd LNVector3_Slide $0081
#cmd LNVector3_Lerp $0082
#cmd LNVector3_CatmullRom $0083
#cmd LNVector3_Transform $0084
#cmd LNVector3_TransformCoord $0085
#cmd LNVector4_Set $0086
#cmd LNMatrix_GetRight $0087
#cmd LNMatrix_GetUp $0088
#cmd LNMatrix_GetFront $0089
#cmd LNMatrix_GetPosition $008A
#cmd LNMatrix_Identity $008B
#cmd LNMatrix_Translate $008C
#cmd LNMatrix_TranslateVec3 $008D
#cmd LNMatrix_RotateX $008E
#cmd LNMatrix_RotateY $008F
#cmd LNMatrix_RotateZ $0090
#cmd LNMatrix_Rotate $0091
#cmd LNMatrix_RotateVec3 $0092
#cmd LNMatrix_RotateAxis $0093
#cmd LNMatrix_RotateQuaternion $0094
#cmd LNMatrix_Scale $0095
#cmd LNMatrix_ScaleXYZ $0096
#cmd LNMatrix_ScaleVec3 $0097
#cmd LNMatrix_Multiply $0098
#cmd LNMatrix_Inverse $0099
#cmd LNMatrix_Transpose $009A
#cmd LNMatrix_ViewTransformLH $009B
#cmd LNMatrix_ViewTransformRH $009C
#cmd LNMatrix_PerspectiveFovLH $009D
#cmd LNMatrix_PerspectiveFovRH $009E
#cmd LNMatrix_OrthoLH $009F
#cmd LNMatrix_OrthoRH $00A0
#cmd LNMatrix_GetEulerAngles $00A1
#cmd LNMatrix_Decompose $00A2
#cmd LNQuaternion_Set $00A3
#cmd LNQuaternion_Identity $00A4
#cmd LNQuaternion_RotationAxis $00A5
#cmd LNQuaternion_RotationMatrix $00A6
#cmd LNQuaternion_RotationYawPitchRoll $00A7
#cmd LNQuaternion_Normalize $00A8
#cmd LNQuaternion_Conjugate $00A9
#cmd LNQuaternion_Multiply $00AA
#cmd LNQuaternion_Slerp $00AB
#cmd LNAudio_PlayBGM $00AC
#cmd LNAudio_PlayBGMMem $00AD
#cmd LNAudio_StopBGM $00AE
#cmd LNAudio_PlayBGS $00AF
#cmd LNAudio_PlayBGSMem $00B0
#cmd LNAudio_StopBGS $00B1
#cmd LNAudio_PlayME $00B2
#cmd LNAudio_PlayMEMem $00B3
#cmd LNAudio_StopME $00B4
#cmd LNAudio_PlaySE $00B5
#cmd LNAudio_PlaySE3D $00B6
#cmd LNAudio_PlaySE3DXYZ $00B7
#cmd LNAudio_PlaySEMem $00B8
#cmd LNAudio_PlaySE3DMem $00B9
#cmd LNAudio_PlaySE3DMemXYZ $00BA
#cmd LNAudio_StopSE $00BB
#cmd LNAudio_SetBGMVolume $00BC
#cmd LNAudio_SetBGSVolume $00BD
#cmd LNSoundListener_SetPosition $00BE
#cmd LNSoundListener_SetDirection $00BF
#cmd LNSoundListener_SetUpDirection $00C0
#cmd LNSoundListener_SetVelocity $00C1
#cmd LNSoundListener_SetPositionXYZ $00C2
#cmd LNSoundListener_SetDirectionXYZ $00C3
#cmd LNSoundListener_SetUpDirectionXYZ $00C4
#cmd LNSoundListener_SetVelocityXYZ $00C5
#cmd LNSound_Create $00C6
#cmd LNSound_CreateMem $00C7
#cmd LNSound_GetVolume $00C8
#cmd LNSound_SetVolume $00C9
#cmd LNSound_GetPitch $00CA
#cmd LNSound_SetPitch $00CB
#cmd LNSound_IsLoopEnabled $00CC
#cmd LNSound_SetLoopEnabled $00CD
#cmd LNSound_SetLoopRange $00CE
#cmd LNSound_Is3DEnabled $00CF
#cmd LNSound_Set3DEnabled $00D0
#cmd LNSound_GetPlayingMode $00D1
#cmd LNSound_SetPlayingMode $00D2
#cmd LNSound_GetPlayingState $00D3
#cmd LNSound_GetPlayedSamples $00D4
#cmd LNSound_GetTotalSamples $00D5
#cmd LNSound_GetSamplingRate $00D6
#cmd LNSound_SetEmitterPosition $00D7
#cmd LNSound_SetEmitterVelocity $00D8
#cmd LNSound_SetEmitterMaxDistance $00D9
#cmd LNSound_Play $00DA
#cmd LNSound_Stop $00DB
#cmd LNSound_Pause $00DC
#cmd LNSound_Resume $00DD
#cmd LNSound_FadeVolume $00DE
#cmd LNSound_SetEmitterPositionXYZ $00DF
#cmd LNSound_SetEmitterVelocityXYZ $00E0
