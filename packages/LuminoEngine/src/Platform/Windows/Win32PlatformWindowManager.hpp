...
public:
    ...
    Result_deprecated<> init(Win32PlatformWindowManager* windowManager, const WindowCreationSettings& settings);
...
public:
    ...
    Result_deprecated<> init(Win32PlatformWindowManager* windowManager, intptr_t windowHandle);
    void dispose() override;
