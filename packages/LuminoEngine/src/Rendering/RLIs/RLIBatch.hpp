...
// 最終的には各 RenderFeature_deprecated が RenderFeatureBatch を実行することで、GraphicsCommandList へ描画命令が渡る。
// 
...
public:
	...
	RenderFeature_deprecated* renderFeature() const { return m_stage->renderFeature; }
...
private:
	RenderFeature_deprecated* m_owner;
