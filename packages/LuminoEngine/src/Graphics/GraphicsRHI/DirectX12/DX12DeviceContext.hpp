...
protected:
    ...
    Result<Ref<IPipeline>> onCreatePipeline(const DevicePipelineCreateInfo& state) override;
...
public:
	DX12Pipeline();
    bool init(DX12Device* deviceContext, const DevicePipelineCreateInfo& state);
