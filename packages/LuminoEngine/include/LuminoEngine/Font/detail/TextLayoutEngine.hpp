...
class TextRun : public RefObject {
public:
};
...
class FlexText : public RefObject {
public:
    void clear() {
        m_glyphs.clear();
        m_glyphRuns.clear();
...
// テキスト描画領の域計算用
class MeasureTextLayoutEngine : public TextLayoutEngine {
public:
    Size areaSize;
...
class BitmapTextRenderer : public TextLayoutEngine {
public:
    void render(
        Bitmap2D* bitmap,
