...
public:
	/** load */
	LN_METHOD()
	static Ref<StaticMesh> load(const StringView& filePath, MeshImportSettings* settings = nullptr);
...
LN_CONSTRUCT_ACCESS:
	...
	bool init(const StringView& filePath, MeshImportSettings* settings);
