...
const Thickness& UIElement::margin() const {
    ...
    return Thickness(
        style->marginLeft.valueOr(Math::NaN),
        style->marginTop.valueOr(Math::NaN),
        style->marginRight.valueOr(Math::NaN),
        style->marginBottom.valueOr(Math::NaN));
}
...
const Thickness& UIElement::padding() const {
    UIStyle* style = m_localStyle->mainStyle();
    return Thickness(
        style->paddingLeft.valueOr(Math::NaN),
        style->paddingTop.valueOr(Math::NaN),
        style->paddingRight.valueOr(Math::NaN),
        style->paddingBottom.valueOr(Math::NaN));
}

void UIElement::setAlignments(UIAlignment value) {
    UIStyle* style = m_localStyle->mainStyle();
    style->marginLeft = Math::NaN;
    style->marginTop = Math::NaN;
    style->marginRight = Math::NaN;
    style->marginBottom = Math::NaN;
    switch (value) {
        case ln::UIAlignment::Left:
            style->marginLeft = 0.0f;
            break;
        case ln::UIAlignment::Top:
            style->marginTop = 0.0f;
            break;
        case ln::UIAlignment::Right:
            style->marginRight = 0.0f;
            break;
        case ln::UIAlignment::Bottom:
            style->marginBottom = 0.0f;
            break;
        case ln::UIAlignment::Center:
            break;
        case ln::UIAlignment::TopLeft:
            style->marginLeft = 0.0f;
            style->marginTop = 0.0f;
            break;
        case ln::UIAlignment::TopRight:
            style->marginTop = 0.0f;
            style->marginRight = 0.0f;
            break;
        case ln::UIAlignment::BottomLeft:
            style->marginLeft = 0.0f;
            style->marginBottom = 0.0f;
            break;
        case ln::UIAlignment::BottomRight:
            style->marginRight = 0.0f;
            style->marginBottom = 0.0f;
            break;
        case ln::UIAlignment::HorizontalStretch:
            style->marginLeft = 0.0f;
            style->marginRight = 0.0f;
            break;
        case ln::UIAlignment::VerticalStretch:
            style->marginTop = 0.0f;
            style->marginBottom = 0.0f;
            break;
        case ln::UIAlignment::LeftStretch:
            style->marginLeft = 0.0f;
            style->marginTop = 0.0f;
            style->marginBottom = 0.0f;
            break;
        case ln::UIAlignment::TopStretch:
            style->marginLeft = 0.0f;
            style->marginTop = 0.0f;
            style->marginRight = 0.0f;
            break;
        case ln::UIAlignment::RightStretch:
            style->marginTop = 0.0f;
            style->marginRight = 0.0f;
            style->marginBottom = 0.0f;
            break;
        case ln::UIAlignment::BottomStretch:
            style->marginLeft = 0.0f;
            style->marginRight = 0.0f;
            style->marginBottom = 0.0f;
            break;
        case ln::UIAlignment::Stretch:
            style->marginLeft = 0.0f;
            style->marginTop = 0.0f;
            style->marginRight = 0.0f;
            style->marginBottom = 0.0f;
...
//    UIStyle* style = m_localStyle->mainStyle();
//    switch (value) {
//        case ln::UIHAlignment::Left:
//            style->marginLeft = 0.0f;
//            break;
//        case ln::UIHAlignment::Center:
//            break;
//        case ln::UIHAlignment::Right:
//            style->marginRight = 0.0f;
//            break;
//        case ln::UIHAlignment::Stretch:
//            style->marginLeft = 0.0f;
//            style->marginRight = 0.0f;
//            break;
//        default:
...
//    UIStyle* style = m_localStyle->mainStyle();
//    switch (value) {
//        case ln::UIVAlignment::Top:
//            style->marginTop = 0.0f;
//            break;
//        case ln::UIVAlignment::Center:
//            break;
//        case ln::UIVAlignment::Bottom:
//            style->marginBottom = 0.0f;
//            break;
//        case ln::UIVAlignment::Stretch:
//            style->marginTop = 0.0f;
//            style->marginBottom = 0.0f;
//            break;
//        default:
