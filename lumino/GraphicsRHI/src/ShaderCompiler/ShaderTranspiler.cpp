    ...
    */
    if (0) {
        ...
        std::string preprocessedCode;
        {
            ...
            if (!preprocessor.preprocess(resource, defaultVersion, EProfile::ENoProfile, false, forwardCompatible, messages, &preprocessedCode, includer)) {
        ...
        */
        if (!m_shader->parse(resource, defaultVersion, forwardCompatible, messages, includer)) {
