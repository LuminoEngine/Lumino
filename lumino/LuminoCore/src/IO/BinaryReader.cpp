...
int64_t BinaryReader::readInt(int byteCount, ByteOrder dataByteOrder) {
    switch (byteCount) {
        case 1:
            return readInt8();
        case 2:
            return readInt16(dataByteOrder);
        case 4:
            return readInt32(dataByteOrder);
        case 8:
            return readInt64(dataByteOrder);
    }
    LN_UNREACHABLE();
    return 0;
}
...
uint64_t BinaryReader::readUInt(int byteCount, ByteOrder dataByteOrder) {
    switch (byteCount) {
        case 1:
            return readUInt8();
        case 2:
            return readUInt16(dataByteOrder);
        case 4:
            return readUInt32(dataByteOrder);
        case 8:
            return readUInt64(dataByteOrder);
    }
    LN_UNREACHABLE();
    return 0;
}
...
String BinaryReader::readString(size_t byteCount, ln::TextEncoding* encoding) {
    ...
    return String((const Char*)m_stringCache.data(), static_cast<int>(m_stringCache.size() / sizeof(Char)));
}
