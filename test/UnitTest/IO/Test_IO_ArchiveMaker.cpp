...
#if defined(LN_OS_WIN32) && defined(LN_UNICODE)
...
TEST_F(Test_IO_ArchiveMaker, Basic)
{
	...
	maker.AddFile(LOCALFILE("TestData/ArchiveText1_1byte.txt"), L"ArchiveText1_1byte.txt");
	maker.AddFile(LOCALFILE("TestData/ArchiveText1_15byte.txt"), L"ArchiveText1_15byte.txt");
	maker.AddFile(LOCALFILE("TestData/ArchiveText1_16byte.txt"), L"ArchiveText1_16byte.txt");
	maker.AddFile(LOCALFILE("TestData/ArchiveText1_17byte.txt"), L"ArchiveText1_17byte.txt");
	maker.AddFile(LOCALFILE("TestData/ArchiveText1_32byte.txt"), L"ArchiveText1_32byte.txt");
	maker.AddFile(LOCALFILE("TestData/ArchiveText1_33byte.txt"), L"ArchiveText1_33byte.txt");
	maker.Close();
	...
	{
		RefPtr<Stream> file;
		archive.TryCreateStream(LOCALFILE("Test1/ArchiveText1_0byte.txt"), &file, false);
	...
	// ArchiveText1_1byte.txt
	{
		char buf[64] = { 0 };
		RefPtr<Stream> file;
		archive.TryCreateStream(LOCALFILE("Test1/ArchiveText1_1byte.txt"), &file, false);
	...
	// ArchiveText1_15byte.txt
	{
		char buf[64] = { 0 };
		RefPtr<Stream> file;
		archive.TryCreateStream(LOCALFILE("Test1/ArchiveText1_15byte.txt"), &file, false);
	...
	// ArchiveText1_16byte.txt
	{
		char buf[64] = { 0 };
		RefPtr<Stream> file;
		archive.TryCreateStream(LOCALFILE("Test1/ArchiveText1_16byte.txt"), &file, false);
	...
	// ArchiveText1_17byte.txt
	{
		char buf[64] = { 0 };
		RefPtr<Stream> file;
		archive.TryCreateStream(LOCALFILE("Test1/ArchiveText1_17byte.txt"), &file, false);
	...
	// ArchiveText1_32byte.txt
	{
		char buf[64] = { 0 };
		RefPtr<Stream> file;
		archive.TryCreateStream(LOCALFILE("Test1/ArchiveText1_32byte.txt"), &file, false);
	...
	// ArchiveText1_33byte.txt
	{
		char buf[64] = { 0 };
		RefPtr<Stream> file;
		archive.TryCreateStream(LOCALFILE("Test1/ArchiveText1_33byte.txt"), &file, false);
