...
bool SSRPostEffectCore::init(Material* compositeMaterial)
{
    ...
    auto descriptor1 = m_ssrMaterial->shaderDescriptor();    // 高速化のため、descripter に直接セットしたい
    m_ssrMaterial_ColorSampler = descriptor1->findParameter2(u"_ColorSampler");
    m_ssrMaterial_NormalAndDepthSampler = descriptor1->findParameter2(u"_NormalAndDepthSampler");
    m_ssrMaterial_ViewDepthSampler = descriptor1->findParameter2(u"_ViewDepthSampler");
    m_ssrMaterial_MetalRoughSampler = descriptor1->findParameter2(u"_MetalRoughSampler");
    ...
    if (!compositeMaterial) {
        ...
        auto descriptor3 = m_ssrCompositeMaterial->shaderDescriptor();    // 高速化のため、descripter に直接セットしたい
        m_paramColorSampler = descriptor3->findParameter2(u"_ColorSampler");
        m_paramSSRSampler = descriptor3->findParameter2(u"_SSRSampler");
    }
