...
Ref<EventConnection> UIToggleButton::connectOnChecked(Ref<UIEventHandler> handler)
{
	return m_onChecked.connect(handler);
}

Ref<EventConnection> UIToggleButton::connectOnUnchecked(Ref<UIEventHandler> handler)
{
