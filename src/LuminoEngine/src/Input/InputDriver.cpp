...
InputDriver::InputDriver()
	...
	, m_mousePoint()
	, m_mouseWheel(0)
	, m_pressedAnyKey(makeRef<KeyGesture>(Keys::Unknown, ModifierKeys::None))
	, m_pressedAnyMouseButton(makeRef<MouseGesture>(MouseAction::None, ModifierKeys::None))
	, m_pressedAnyGamepadElement(makeRef<GamepadGesture>(GamepadElement::None))
{
