...
struct LN_VSIInput
{
    ...
    float4 InstanceTransform1 : POSITION1;
    float4 InstanceTransform2 : POSITION2;
    float4 InstanceTransform3 : POSITION3;
};
...
LN_VSIOutput VSI_Main(LN_VSIInput input)
{
	...
	LN_VSIOutput o;
	o.svPos			= mul(worldPos, ln_ViewProjection);
...
technique Forward_Geometry_Instancing
{
    pass Pass1
    {
