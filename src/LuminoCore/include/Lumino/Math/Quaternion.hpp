 ...
 * デジタルアート系の3Dグラフィックスの線形代数ライブラリとしては
 * この動作がほぼ一般的なので、これに合わせています。(DirectX(D3DX)、XNA、Unity、cocos2dx 等はこの動作)
 */
...
public:
     ...
     * クォータニオンは order に指定された順序で乗算されたものでなければ本来の回転角度が取得できないことに注意してください。<br>
