...
static ln::Key TranslateKey(std::uint16_t keyCode)
{
    using Key = ln::Key;
    constexpr Key keyTable[127] = {
        ...
        /* 0x18 */ Key::Unknown,    //Key::Equals, // kVK_ANSI_Equal
        ...
        /* 0x32 */ Key::Unknown,    //Key::AccentGrave, // kVK_ANSI_Grave
        /* 0x33 */ Key::Delete, // kVK_Delete
        /* 0x34 */ Key::Unknown,
        /* 0x35 */ Key::Escape, // kVK_Escape
        /* 0x36 */ Key::Unknown,    //Key::RightApple, // NOTE: maybe
        /* 0x37 */ Key::Unknown,    //Key::LeftApple, // kVK_Command
        /* 0x38 */ Key::LShift, // kVK_Shift
        /* 0x39 */ Key::Unknown,    //Key::CapsLock, // kVK_CapsLock
        /* 0x3A */ Key::LAlt, // kVK_Option
        /* 0x3B */ Key::LCtrl, // kVK_Control
        /* 0x3C */ Key::RShift, // kVK_RightShift
        /* 0x3D */ Key::RAlt, // kVK_RightOption
        /* 0x3E */ Key::RCtrl, // kVK_RightControl
        /* 0x3F */ Key::Unknown, // kVK_Function
        /* 0x40 */ Key::Unknown, // kVK_F17
        /* 0x41 */ Key::Unknown,    //Key::KeypadDecimal, // kVK_ANSI_KeypadDecimal
        /* 0x42 */ Key::Unknown,
        /* 0x43 */ Key::Unknown,    //Key::KeypadMultiply, // kVK_ANSI_KeypadMultiply
        /* 0x44 */ Key::Unknown,
        /* 0x45 */ Key::Unknown,    //Key::KeypadAdd, // kVK_ANSI_KeypadPlus
        /* 0x46 */ Key::Unknown,
        /* 0x47 */ Key::Unknown,    //Key::Clear, // kVK_ANSI_KeypadClear
        /* 0x48 */ Key::Unknown, // kVK_VolumeUp
        /* 0x49 */ Key::Unknown, // kVK_VolumeDown
        /* 0x4A */ Key::Unknown, // kVK_Mute
        /* 0x4B */ Key::Unknown,    //Key::KeypadDivide, // kVK_ANSI_KeypadDivide
        /* 0x4C */ Key::Enter, // kVK_ANSI_KeypadEnter
        /* 0x4D */ Key::Unknown,
        /* 0x4E */ Key::Unknown,    //Key::KeypadSubtract, // kVK_ANSI_KeypadMinus
        /* 0x4F */ Key::Unknown, // kVK_F18
        /* 0x50 */ Key::Unknown, // kVK_F19
        /* 0x51 */ Key::Unknown,    //Key::Equals, // kVK_ANSI_KeypadEquals
        /* 0x52 */ Key::Unknown,    //Key::Keypad0, // kVK_ANSI_Keypad0
        /* 0x53 */ Key::Unknown,    //Key::Keypad1, // kVK_ANSI_Keypad1
        /* 0x54 */ Key::Unknown,    //Key::Keypad2, // kVK_ANSI_Keypad2
        /* 0x55 */ Key::Unknown,    //Key::Keypad3, // kVK_ANSI_Keypad3
        /* 0x56 */ Key::Unknown,    //ey::Keypad4, // kVK_ANSI_Keypad4
        /* 0x57 */ Key::Unknown,    //Key::Keypad5, // kVK_ANSI_Keypad5
        /* 0x58 */ Key::Unknown,    //Key::Keypad6, // kVK_ANSI_Keypad6
        /* 0x59 */ Key::Unknown,    //Key::Keypad7, // kVK_ANSI_Keypad7
        /* 0x5A */ Key::Unknown, // kVK_F20
        /* 0x5B */ Key::Unknown,    //Key::Keypad8, // kVK_ANSI_Keypad8
        /* 0x5C */ Key::Unknown,    //Key::Keypad9, // kVK_ANSI_Keypad9
        ...
        /* 0x68 */ Key::Unknown,    //Key::KanaMode, // kVK_JIS_Kana
        /* 0x69 */ Key::Unknown,    //Key::F13, // kVK_F13
        /* 0x6A */ Key::Unknown, // kVK_F16
        /* 0x6B */ Key::Unknown,    //Key::F14, // kVK_F14
        /* 0x6C */ Key::Unknown,
        /* 0x6D */ Key::F10, // kVK_F10
        /* 0x6E */ Key::Unknown,
        /* 0x6F */ Key::F12, // kVK_F12
        /* 0x70 */ Key::Unknown,
        /* 0x71 */ Key::Unknown,    //Key::F15, // kVK_F15
        /* 0x72 */ Key::Unknown,    //Key::Help, // kVK_Help
...
static ln::ModifierKeys TranslateModifierKeyFlags(NSUInteger flags)
{
    using ModifierKeys = ln::ModifierKeys;
...
{
    ln::CocoaPlatformWindow*	m_host;
	NSTrackingArea*             m_trackingArea;		// マウスイベントを受け取るために必要
}

- (id)initWithPlatformWindow:(ln::CocoaPlatformWindow *)host;

@end

@implementation CocoaPlatformCoreView
...
{
    const ln::Key key = TranslateKey([event keyCode]);
	const ln::ModifierKeys mods = TranslateModifierKeyFlags([event modifierFlags]);
	m_host->SendPlatformKeyEvent(ln::PlatformEventType::KeyDown, m_host, key, mods, 0);
	...
	for (i = 0; i < length; i++)
	{
		...
		m_host->SendPlatformKeyEvent(ln::PlatformEventType::KeyDown, m_host, key, mods, codepoint);
	}
}
...
{
    ln::Key key = TranslateKey([event keyCode]);
    ln::ModifierKeys mods = TranslateModifierKeyFlags([event modifierFlags]);
	m_host->SendPlatformKeyEvent(ln::PlatformEventType::KeyUp, m_host, key, mods, 0);
}
...
@implementation CocoaPlatformCoreWindowDelegate
...
- (void)windowDidResize:(NSNotification*)notification
{
   ...
   return;
   */
	const NSRect contentRect = [m_host->GetView() frame];
...
void CocoaPlatformWindow::Initialize(CocoaPlatformWindowManager* windowManager, String windowTitle, int width, int height, bool fullscreen, bool resizable)
{
	...
	//if ()
	//	windowStyle = NSBorderlessWindowMask;	// フルスクリーンにするならこれ
	//else
	{
		windowStyle = NSTitledWindowMask | NSClosableWindowMask | NSMiniaturizableWindowMask;
		if (resizable)
	...
	m_window = [[CocoaPlatformCoreWindow alloc]
				...
				defer:NO];
	LN_THROW(m_window != nil, InvalidOperationException);
	...
	// View 作成
	m_view = [[CocoaPlatformCoreView alloc] initWithPlatformWindow:this];
