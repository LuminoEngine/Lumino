...
#include "../Core/Generators/RegisterTypesGenerator.hpp"
...
int main(int argc, char** argv) {
    ...
    // Core
    {
        ...
        module->addInputFile(U"include/LuminoCore/Base/Logger.hpp");
        module->addInputFile(U"include/LuminoCore/Math/Vector3.hpp");
        module->addInputFile(U"include/LuminoCore/Math/Vector4.hpp");
        module->addInputFile(U"include/LuminoCore/Math/Quaternion.hpp");
        module->addInputFile(U"include/LuminoCore/Math/Matrix.hpp");
        module->addInputFile(U"include/LuminoCore/Text/Encoding.hpp");
        module->addInputFile(U"include/LuminoCore/Geometries/GeometryStructs.hpp");
    ...
    // Runtime
    {
        ...
        module->setOutputRegisterTypesFile(U"src/RegisterTypes.inl");
...

    {
        for (auto& module : project->modules) {
            RegisterTypesGenerator g;
            g.setup(db, config);
            g.generate(module.get());
        }
    }
    //{
