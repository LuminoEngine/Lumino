...
//ライト関連
uniform bool		ln_LightEnables[LN_LightCount];		// 有効フラグ
uniform vec3		ln_LightDirections[LN_LightCount];	// 方向
uniform vec3		ln_LightPositions[LN_LightCount];	// ライト位置
uniform float		ln_LightZFars[LN_LightCount];		// ライトzFar値
