/*
    ...
    Commandline:
        --profile="core" --api="gl=4.0,gles2=3.0" --generator="c" --spec="gl" --extensions=""
    Online:
        http://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D4.0&api=gles2%3D3.0
*/
