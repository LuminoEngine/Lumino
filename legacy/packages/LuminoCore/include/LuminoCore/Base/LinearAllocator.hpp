...
/*
    ...
    LinearAllocatorPageManager と AbstractLinearAllocator の関係は次のとおり 1:n。
    Graphics の ConstantBuffer のユースケースとしては、
    - LinearAllocatorPageManager は全体でひとつ。
    - AbstractLinearAllocator は CommnadList ごとにある。
                   ...
                   |                        |                        |
    +-------------------------+ +-------------------------+ +-------------------------+
    | AbstractLinearAllocator | | AbstractLinearAllocator | | AbstractLinearAllocator |
    +-------------------------+ +-------------------------+ +-------------------------+
*/
