#include "Common.hpp"
#include "../../LuminoEngine/src/GPU/RenderTargetTextureCache.hpp"
...
TEST_F(Test_Graphics_Texture, clear) {
    ...
    //* [ ] クリア
    {
        ...
        sprite->setAlignments(UIAlignment::TopLeft);
...
TEST_F(Test_Graphics_Texture, drawText) {
    ...
    //* [ ] 余白がある場合の配置テスト
    {
        ...
        context->drawText(_TT("Left"), Rect(10, 10, 140, 100), font, Color::White, TextAlignment::Forward);
        context->drawText(_TT("Center"), Rect(10, 10, 140, 100), font, Color::White, TextAlignment::Center);
        context->drawText(_TT("Right"), Rect(10, 10, 140, 100), font, Color::White, TextAlignment::Backward);
        context->drawText(_TT("Justify"), Rect(10, 50, 140, 100), font, Color::White, TextAlignment::Justify);
        auto sprite = UISprite::create(texture);
        sprite->setAlignments(UIAlignment::TopLeft);
        sprite->setBlendMode(BlendMode::Alpha);
        Engine::mainUIView()->addElement(sprite);
    ...
    //* [ ] 余白がない場合の配置テスト
    {
        auto texture = Texture2D::create(160, 120);
        auto context = texture->getContext();
        context->drawText(_TT("Left"), Rect(0, 0, 160, 120), font, Color::White, TextAlignment::Forward);
        context->drawText(_TT("Center"), Rect(0, 0, 160, 120), font, Color::White, TextAlignment::Center);
        context->drawText(_TT("Right"), Rect(0, 0, 160, 120), font, Color::White, TextAlignment::Backward);
        context->drawText(_TT("Justify"), Rect(0, 30, 160, 160), font, Color::White, TextAlignment::Justify);
        auto sprite = UISprite::create(texture);
        sprite->setAlignments(UIAlignment::TopLeft);
        sprite->setBlendMode(BlendMode::Alpha);
        Engine::mainUIView()->addElement(sprite);
