...
{
	auto vm = Matrix::makeLookAtLH(Vector3(0, 0, -10), Vector3::Zero, Vector3::UnitY);
		auto pm = Matrix::makePerspectiveFovLH(Math::PI / 4, 640.0 / 480.0, 0.1, 1000);
	ViewFrustum vf = ViewFrustum(vm * pm);
