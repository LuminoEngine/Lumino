...
LN_CONSTRUCT_ACCESS:
	...
	bool initialize(btCollisionShape* shape);
...
LN_INTERNAL_ACCESS:
	...
	bool initialize(const Vector3& direction);
};
...
LN_CONSTRUCT_ACCESS:
	...
	LN_METHOD()
	bool initialize(const Vector3& size);
};
...
LN_CONSTRUCT_ACCESS:
	...
	bool initialize(float radius, float height);
};
...
LN_CONSTRUCT_ACCESS:
	...
	bool initialize(MeshResource* mesh);
