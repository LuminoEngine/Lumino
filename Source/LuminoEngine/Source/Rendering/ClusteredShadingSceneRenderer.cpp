...
void ClusteredShadingGeometryRenderingPass::initialize()
{
	...
	m_defaultShader = Shader::create(_T("C:/Proj/LN/HC1/External/Lumino/Source/LuminoEngine/Source/Rendering/Resource/ClusteredShadingDefault.fx"), ShaderCodeType::RawHLSL);
