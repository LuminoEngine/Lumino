...
TEST_F(Test_Matrix, Basic)
{
	...
	// Matrix::RotationEulerAngles
	{
		...
		// ÉfÉtÉHÉãÉgà¯êîÇÃèáèòÇÕ YawPitchRoll Ç∆àÍívÇ∑ÇÈ
		m = Matrix::Identity;
	...
	// this->toEulerAngles
	{
		// ÉfÉtÉHÉãÉgà¯êîÇ≈ÇÕÇ±ÇÃâÒì]èáèò
		Matrix m;
		...
		// ÉfÉtÉHÉãÉgà¯êîÇ≈ YawPitchRoll ÇµÇΩÇ‡ÇÃÇ™éÊÇËèoÇπÇÈ
		...
		ASSERT_EQ(false, locked);	// ÉWÉìÉoÉãÉçÉbÉNÇµÇ»Ç¢
		ASSERT_VEC3_NEAR(0.5, 0.75, 1.0, angles);
	...
	{
		// ìKìñÇ…à⁄ìÆÇ∆âÒì]ÇÃå„ÅAÉNÉHÅ[É^ÉjÉIÉìÅ®çsóÒÇèÊéZ
		D3DXMATRIX dxT;
		D3DXMatrixTranslation(&dxT, 5, 6, 7);
		D3DXMATRIX dxR;
		D3DXMatrixRotationYawPitchRoll(&dxR, 1, 2, 3);
	...
	{
		// D3DXMatrixRotationYawPitchRoll ÇÃâÒì]èáèòÇÕ Z > X > Y
		D3DXMATRIX dxRx;
	...
	Å~D3DXMatrixDeterminant
	D3DXMatrixIdentity
	D3DXMatrixIsIdentity
	D3DXMatrixMultiply
	Å~D3DXMatrixMultiplyTranspose
	...
	D3DXMatrixOrthoLH
	D3DXMatrixOrthoRH
	Å~D3DXMatrixOrthoOffCenterLH
	Å~D3DXMatrixOrthoOffCenterRH
	D3DXMatrixPerspectiveFovLH
	D3DXMatrixPerspectiveFovRH
	Å~D3DXMatrixPerspectiveLH
	Å~D3DXMatrixPerspectiveRH
	Å~D3DXMatrixPerspectiveOffCenterLH
	Å~D3DXMatrixPerspectiveOffCenterRH

	D3DXMatrixAffineTransformation
	Å~D3DXMatrixTransformation
