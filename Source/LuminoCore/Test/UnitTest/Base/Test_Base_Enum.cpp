...
template<typename EnumType, typename MaskType = FlagsType>
class Flags
{
public:
	Flags()
	...
	Flags(Flags<EnumType> const& rhs)
		: m_mask(rhs.m_mask)
	{
	}
	...
	{
		return (m_mask & static_cast<MaskType>(value)) == static_cast<MaskType>(value);
	}

	Flags<EnumType>& set(EnumType value)
	{
		m_mask |= static_cast<MaskType>(value);
		return *this;
	}
	...
	Flags<EnumType> & operator=(Flags<EnumType> const& rhs)
	{
		m_mask = rhs.m_mask;
		return *this;
	}
	...
	Flags<EnumType> operator|(Flags<EnumType> const& rhs) const
	{
	...
	{
		Flags<EnumType> result(*this);
		result.m_mask = (MaskType)~m_mask;//^= FlagTraits<EnumType>::allFlags;
		return result;
	}

	bool operator==(Flags<EnumType> const& rhs) const
	{
...
//Flags<EnumType> operator|(EnumType bit, Flags<EnumType> const& flags)
//{
//	return flags | bit;
//}
//
...
#define LN_FLAGS_OPERATORS(EnumType) \
	inline bool operator==(EnumType lhs, const ln::Flags<EnumType>& rhs) { return rhs == lhs; } \
	inline bool operator!=(EnumType lhs, const ln::Flags<EnumType>& rhs) { return rhs != lhs; } \
	inline ln::Flags<EnumType> operator|(EnumType lhs, const ln::Flags<EnumType>& rhs) { return rhs | lhs; } \
	inline ln::Flags<EnumType> operator&(EnumType lhs, const ln::Flags<EnumType>& rhs) { return rhs & lhs; } \
	inline ln::Flags<EnumType> operator^(EnumType lhs, const ln::Flags<EnumType>& rhs) { return rhs ^ lhs; } \
	inline ln::Flags<EnumType> operator|(EnumType lhs, EnumType rhs) { return ln::Flags<EnumType>(lhs) | rhs; } \
	inline ln::Flags<EnumType> operator&(EnumType lhs, EnumType rhs) { return ln::Flags<EnumType>(lhs) & rhs; } \
	inline ln::Flags<EnumType> operator^(EnumType lhs, EnumType rhs) { return ln::Flags<EnumType>(lhs) ^ rhs; } \
